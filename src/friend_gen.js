...
const randomPoints = (n, width, height, xOffset, yOffset) => {
  const points = [];
  for (let i = 0; i < n; i++) {
...
const getRightmostPoint = points => {
  var right = 0;
...
const sortedPoints = (points, width, height, xOffset, yOffset) => {
...
function generateShape(numPoints, width, height, xOffset, yOffset) {
  ...
  ctx.beginPath();
  ctx.arc(
    sorted[right][0] + centerOffsetX,
    sorted[right][1] + centerOffsetY,
    10,
    0,
    2 * Math.PI
  );
  ...
  ctx.beginPath();
  ctx.arc(
    sorted[right][0] + centerOffsetX - 2,
    sorted[right][1] + centerOffsetY - 2,
    4,
    0,
    2 * Math.PI
  );
  ...
  ctx.beginPath();
  ctx.arc(
    newPoint[0] + centerOffsetX,
    newPoint[1] + centerOffsetY,
    10,
    0,
    2 * Math.PI
  );
  ...
  ctx.beginPath();
  ctx.arc(
    newPoint[0] + centerOffsetX - 2,
    newPoint[1] + centerOffsetY - 2,
    4,
    0,
    2 * Math.PI
  );
